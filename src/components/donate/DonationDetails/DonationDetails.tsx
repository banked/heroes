...
class DonationDetails extends React.Component<Props, State> {
  ...
  handleEmailChange = (e) => {
    ...
    render() {
      return (
        <div>
            <div className="your-details__fields">
            <div className="your-details__field">
              <label className="your-details__field__label" htmlFor="payment_session_user_name">Name</label>
              <input
                required
                ref={this.nameInput}
                type="text"
            ...
            <div className="your-details__field">
              <label className="your-details__field__label" htmlFor="payment_session_email">Email</label>
              <input
                required
                ref={this.emailInput}
                type="email"
